...
이 문서는 Flyway 마이그레이션 `V1`~`V29`를 기준으로 작성한 현재 MySQL 물리 스키마 ERD다.
...
- DDL: `src/main/resources/db/migration/V1__create_university.sql`부터 `V29__split_hanshin_2026_and_2027_rules.sql`까지
